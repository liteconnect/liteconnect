...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/liteconnect-project/liteconnect>";
    const std::string URL_WEBSITE = "<https://liteconnect.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Liteconnect version %s\n", FormatFullVersion());
}
