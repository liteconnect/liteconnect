...
#if defined(NDEBUG)
# error "Liteconnect cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Liteconnect Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LCN additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
	...
	if (nHeight == 1) {
		nSubsidy = 54000000 * COIN; // 100% pre-mined for market
    }	
