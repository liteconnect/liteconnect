...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s liteconnect-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  liteconnect-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded liteconnect transaction") + "\n" +
              "  liteconnect-tx [options] -create [commands]   " + _("Create hex-encoded liteconnect transaction") + "\n" +
              "\n";
